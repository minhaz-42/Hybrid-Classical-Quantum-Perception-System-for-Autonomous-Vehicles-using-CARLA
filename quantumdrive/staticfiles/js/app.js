...
const COLORS = {
  green:  '#00E676', greenBg:  'rgba(0,230,118,.12)',
  blue:   '#5D8CFF', blueBg:   'rgba(93,140,255,.12)',
  purple: '#A855F7', purpleBg: 'rgba(168,85,247,.12)',
  orange: '#FFB74D', orangeBg: 'rgba(255,183,77,.12)',
  red:    '#FF5252', redBg:    'rgba(255,82,82,.12)',
  teal:   '#00BFA5', tealBg:   'rgba(0,191,165,.12)',
  cyan:   '#00E5FF', cyanBg:   'rgba(0,229,255,.12)',
...
if (typeof Chart !== 'undefined') {
  ...
  Chart.defaults.plugins.tooltip.backgroundColor = '#1F2A44';
  Chart.defaults.plugins.tooltip.borderColor     = 'rgba(93,140,255,0.2)';
  Chart.defaults.plugins.tooltip.borderWidth     = 1;
  Chart.defaults.plugins.tooltip.cornerRadius    = 10;
  Chart.defaults.plugins.tooltip.padding          = 12;
  Chart.defaults.plugins.tooltip.titleFont        = { weight: '600' };
  Chart.defaults.plugins.tooltip.titleColor       = '#E0E6ED';
  Chart.defaults.plugins.tooltip.bodyColor        = '#8A94A6';
}
...
function drawDrivingFrame() {
  ...
  carGrad.addColorStop(0, '#5D8CFF');
  carGrad.addColorStop(1, '#3A6AE0');
  ...
  if (confWidth > 0) {
    ctx.fillStyle = drivingState.confidence > 0.7 ? '#00E676' : drivingState.confidence > 0.4 ? '#FFB74D' : '#FF5252';
